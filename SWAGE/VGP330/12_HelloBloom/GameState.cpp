...
void GameState::Initialize()
{
	...
	mEarthMesh = MeshBuilder::CreateSphere(256, 256, 1.0f);
	mEarthMeshBuffer.Initialize(mEarthMesh);

	mSunMesh = MeshBuilder::CreateSpherePX(256, 256, 5.0f);
	...
	mSunDiffuseTexture.Initialize(L"../../Assets/Images/sun_texture.jpg");
