...
{
	//SWAGE::Graphics::SimpleDraw::AddLine({ 0,0,0 }, { 20,50,0 }, SWAGE::Graphics::Colors::Cyan);
	//SWAGE::Graphics::SimpleDraw::AddLine({ 20,0,0 }, { 200,505,0 }, SWAGE::Graphics::Colors::White);
	//SWAGE::Graphics::SimpleDraw::AddAABB({ 0,0,30 }, { 5,5,5 }, SWAGE::Graphics::Colors::Red);
	//SWAGE::Graphics::SimpleDraw::AddSphere({ 0,0,25 }, 5, SWAGE::Graphics::Colors::Yellow);
	SWAGE::Graphics::SimpleDraw::AddGroundPlane({ 0,0,0 }, SWAGE::Graphics::Colors::Blue, 100);
